...
class Prof1():
    def get_profile(self, tunables, **kwargs):
        ...
        profiles = [
            ("pcaps/iec104.pcap",         "192.168.3.1", "192.168.3.3",  "192.168.3.100", "192.168.3.100"),
            ("pcaps/s7comm.pcap",         "192.168.4.1", "192.168.4.3",  "192.168.4.100", "192.168.4.100"),
            ("pcaps/modbus.pcap",         "192.168.5.1", "192.168.5.3",  "192.168.5.100", "192.168.5.100"),
            ("pcaps/opcua.pcap",         "192.168.6.1", "192.168.6.3",  "192.168.6.100", "192.168.6.100"),
            ("pcaps/dnp3.pcap",           "192.168.7.1", "192.168.7.3",  "192.168.7.100", "192.168.7.100")
              ]
